...
#自定义服务列表
server_list[0]=message-service
server_list[1]=common-service
server_list[2]=admin-service
server_list[3]=gateway
server_list[4]=item-service
server_list[5]=number-service
server_list[6]=statistics-service
server_list[7]=visitors-service
server_list[8]=api
server_list[9]=accept-service
server_list[10]=alibaba-service
server_list[11]=authenticate-service
server_list[12]=express-service
server_list[13]=handling-service
server_list[14]=mailbox-service
server_list[15]=preaudit-service
#阿里云私有docker仓库地址
