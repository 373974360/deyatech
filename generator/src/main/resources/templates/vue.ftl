    ...
    <#list table.fields as column>
        ...
        <#else>
            ...
            <el-table-column prop="enable" class-name="status-col" :label="${dollar}t('table.operation')" align="center" width="150">
                <template slot-scope="scope">
                    <el-button :title="${dollar}t('table.create')" type="primary" icon="el-icon-plus" :size="btnSize" circle
                               @click.stop.safe="btnCreate(scope.row)"></el-button>
                    <el-button :title="${dollar}t('table.update')" type="primary" icon="el-icon-edit" :size="btnSize" circle
                               @click.stop.safe="btnUpdate(scope.row)"></el-button>
                    <el-button :title="${dollar}t('table.delete')" type="danger" icon="el-icon-delete" :size="btnSize" circle
    ...
    export default {
        ...
        methods: {
            ...
            btnUpdate(row){
                this.reset${entity}();
                if (row.id) {
                    this.${lowerEntity} = copyProperties(this.${lowerEntity}, row);
                } else {
                    this.${lowerEntity} = copyProperties(this.${lowerEntity}, this.selectedRows[0]);
                }
...
<template>
    <basic-container>
        <div class="deyatech-container pull-auto">
            ...
            <div class="deyatech-menu">
                <div class="deyatech-menu_left">
                    <el-button type="primary" :size="btnSize" @click="btnCreate">{{${dollar}t('table.create')}}</el-button>
                    <el-button type="primary" :size="btnSize" @click="btnUpdate" :disabled="selectedRows.length != 1">{{${dollar}t('table.update')}}</el-button>
                    <el-button type="danger" :size="btnSize" @click="btnDelete" :disabled="selectedRows.length < 1">{{${dollar}t('table.delete')}}</el-button>
                </div>
                <div class="deyatech-menu_right">
