...
@RestController
public class BaseProcessDiagramResource extends BaseController {
    ...
    private void getActivity(String processInstanceId, ActivityImpl activity, ArrayNode activityArray, ArrayNode sequenceFlowArray,
        ...
        Process mainProcess = repositoryService.getBpmnModel(activity.getProcessDefinition().getId()).getMainProcess();
        ...
        if ("userTask".equals(properties.get("type"))) {
            ...
            //组
            //指定了人
            UserTask flowElement = (UserTask) mainProcess.getFlowElement(activity.getId());
            propertiesJSON.put("assignee", flowElement.getAssignee());
//            propertiesJSON.put("candidateUsers", "");
//            propertiesJSON.put("candidateGroups", "");
        }
