...
public class ProcessHighlightsController extends BaseController {
    ...
    @GetMapping(value = "/process-instance/{processInstanceId}/highlights", produces = "application/json;charset=utf-8")
    public String getHighlights(@PathVariable String processInstanceId) {
